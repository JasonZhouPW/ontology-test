...
char * contractaddr = "AWU46okiDYcjpjVmPmtQSs11Q2Vo5JbCU2";

char * selfAddr(){
        return ONT_CallContract(contractaddr,"selfAddr",null);

}

char * callerAddr(){
        return ONT_CallContract(contractaddr,"callerAddr",null);
}

char * entryAddr(){
        return ONT_CallContract(contractaddr,"entryAddr",null);
}
