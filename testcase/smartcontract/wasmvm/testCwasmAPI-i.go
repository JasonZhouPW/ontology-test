...
func TestCWasmAPI2(ctx *testframework.TestFrameworkContext) bool {

	testFile := filePath + "/" + "cwasmAPI2.wasm"
	...
	ctx.LogInfo("===================== call contract ==============================")
	ccaddr ,_ := common.AddressFromBase58("AejAq97DaWUh17iwJ7cnfMKkdS5mr5hSgh")
	res, err = PreExecWasmContract(ctx,
		addr,
		"callcrt",
		[]interface{}{ccaddr})
